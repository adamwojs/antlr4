...
abstract class AbstractParseTreeVisitor extends BaseObject implements ParseTreeVisitor
{
    /**
     * {@inheritdoc}
     *
    ...
    public function visitChildren(RuleNode $node)
    {
        ...
        for ($i = 0; $i < $node->getChildCount(); $i++) {
            ...
            $result = $this->aggregateResult($result, $node->getChild($i)->accept($this));
        }
     ...
     */
    protected function shouldVisitNextChild(RuleNode $node, $result): bool
    {
        return true;
    }
}
