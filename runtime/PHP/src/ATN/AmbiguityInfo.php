...
class AmbiguityInfo extends DecisionEventInfo
{
     ...
     * @param \ANTLR\v4\Runtime\ATN\ATNConfigSet $configs The final configuration set identifying the ambiguous
     * alternatives for the current input
     * @param \ANTLR\v4\Runtime\Misc\BitSet $ambigAlts The set of alternatives in the decision that lead to a valid
     * parse. The predicted alt is the min(ambigAlts)
     ...
     * @param int $stopIndex The index at which the ambiguity was identified during prediction
     * @param bool $fullCtx {@code true} if the ambiguity was identified during LL prediction; otherwise, {@code false}
     * if the ambiguity was identified during SLL prediction
     */
